...
exports.normaliseMealText = normaliseMealText;
exports.fnv1a64 = fnv1a64;
exports.libraryIdFor = libraryIdFor;
function normaliseMealText(raw) {
    return raw
        .toLowerCase()
        .replace(/[^\p{L}\p{N} ]+/gu, ' ')
        .replace(/\s+/g, ' ')
...
function libraryIdFor(text) {
    return fnv1a64(normaliseMealText(text));
}
//# sourceMappingURL=mealText.js.map